...
<?php if ($isModal): ?>
    <div class="modal-header">
        <h2>Editar Pedido #<?= (int) $editing['id'] ?></h2>
...
<form action="/painel/pedidos/<?= (int) $editing['id'] ?>" method="post" enctype="multipart/form-data" class="panel-form panel-form-wide<?= $isModal ? ' ajax-form' : '' ?>" id="order-form">
    <?= Csrf::field() ?>
