...
<p class="hint-text">Preço de referência (venda avulsa, 1 unidade). Vendas com mais de uma unidade seguem a <a href="/painel/tabela-precos">tabela de preços por quantidade</a>.</p>
