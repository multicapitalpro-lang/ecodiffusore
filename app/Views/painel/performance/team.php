...
$renderPerson = function (array $person, string $roleLabel, string $icon) use (&$totals) {
    ...
    <div class="team-node">
        ...
        <div class="team-node-meta">
            <span><?= View::e($person['commission_pct'] !== null ? number_format((float) $person['commission_pct'], 2, ',', '.') . '% do pedido' : 'sem % definido') ?></span>
            <?php if ($t): ?>
...
<details class="team-tree-details" style="margin-top:28px;">
    ...
    <div class="team-branch">
        <div class="team-node team-node-gestor">
            ...
            <div class="team-node-meta">
                <span><?= View::e($licenciado['commission_pct'] !== null ? number_format((float) $licenciado['commission_pct'], 2, ',', '.') . ($rootIsGestor ? '% do pedido' : '% (contratual)') : 'sem % definido') ?></span>
                ...
                <?php if ($filho['role_slug'] === 'gestor'): ?>
                    <div class="team-branch">
                        <div class="team-node team-node-supervisor">
                            ...
                            <div class="team-node-meta">
                                <span><?= View::e($filho['commission_pct'] !== null ? number_format((float) $filho['commission_pct'], 2, ',', '.') . '% do pedido' : 'sem % definido') ?></span>
