...
<?php if ($hasMetrics): ?>
    ...
    <?php if (isset($pricingTiersRef) && $pricingTiersRef): ?>
        <h3 class="section-title" style="margin:28px 0 0;">Faixas de preço negociável</h3>
    ...
    <?php if (isset($vendorOwnTiers) && $vendorOwnTiers): ?>
        <h3 class="section-title" style="margin:28px 0 0;">Sua comissão por faixa de preço</h3>
