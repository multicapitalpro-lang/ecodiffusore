...
<?php else: ?>
    ...
    <form id="proposta-form" action="/painel/proposta-facil" method="post" class="panel-form panel-form-wide" data-modal="<?= $isModal ? '1' : '' ?>"
        ...
        <h3>Veículo</h3>
            ...
            <?php if (!empty($secondaryCurrency)): ?>
                <?php $currencySymbol = \App\Core\Money::symbol($secondaryCurrency); ?>
                <div class="form-grid-2">
                    <div>
                    ...
                    <div>
                        <label for="preco_diesel">Preço médio do diesel na região (<span id="diesel-unit-label">R$</span>/litro)</label>
